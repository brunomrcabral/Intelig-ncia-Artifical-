...
public class iterativa {
    public static void iter( ArrayList<No> L , int [][] sol ) {
        int contador = 0;
        int iguais = 0, xi = 0;
        Scanner ler = new Scanner(System.in);
        System.out.println("Profundidade desejada : ");
        int pfinal = ler.nextInt();
        int prof;

        while (xi != 1 && L.size()!=0) {                                        //Para funcionar caso a pfinal escolhida ser inferior a prof da sol.
            int x0 = 0;
            int y0 = 0;
